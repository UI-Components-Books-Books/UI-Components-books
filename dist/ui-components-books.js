...
` + se[Ee].replace(" at new ", " at ");
    ...
    var zn = function(g, M, Y, re, fe, he, le) {
      var se = {
    ...
    function Cr(g, M, Y, re, fe) {
      {
        ...
        Y !== void 0 && (Lt(Y), se = "" + Y), Er(M) && (Lt(M.key), se = "" + M.key), Vn(M) && (qe = M.ref, Tr(M, fe));
        for (he in M)
        ...
        return zn(g, se, qe, fe, re, Be.current, le);
      }
    }
...
const Qt = {
  ...
  ({ id: e, name: t, type: n, label: r, state: a, value: i, addClass: c, isDisabled: s, defaultChecked: d, onChange: f, __TYPE: l, inherit: u, ...v }, h) => {
    const m = xe(() => e || Ha(`ui-${n}`), [e, n]), b = Object.freeze({
...
function Jl(e) {
  ...
  const {
    announce: i,
    announcement: c
  } = Gl(), s = fr("DndLiveRegion"), [d, f] = te(!1);
  if (Q(() => {
    f(!0);
  }, []), Zl(xe(() => ({
    onDragStart(u) {
...
const Hc = {
  ...
  over: null,
  measureDroppableContainers: ar
}, vr = /* @__PURE__ */ ut(Gc), Zc = /* @__PURE__ */ ut(Hc);
function Xc() {
  return {
    draggable: {
      active: null,
...
const nu = /* @__PURE__ */ $a(function(t) {
  ...
  const b = uo(Kc, void 0, Xc), [w, _] = b, [D, E] = Xl(), [I, x] = te(Nt.Uninitialized), j = I === Nt.Initialized, {
    draggable: {
      active: T,
      nodes: N,
      translate: W
    ...
    return T != null ? {
      ...
      data: (_e = F == null ? void 0 : F.data) != null ? _e : Uc,
      rect: z
    } : null;
  }, [T, F]), X = J(null), [oe, Z] = te(null), [K, ue] = te(null), ie = Dn(m, Object.values(m)), P = fr("DndDescribedBy", c), k = xe(() => H.getEnabled(), [H]), y = eu(v), {
    droppableRects: O,
    ...
    config: y.droppable
  }), S = Nc(N, T), A = xe(() => K ? eo(K) : null, [K]), q = Wn(), U = Mc(S, y.draggable.measure);
  tu({
  ...
  const V = ia(S, y.draggable.measure, U), de = ia(S ? S.parentElement : null), L = J({
  ...
  }), B = H.getNodeFor((n = L.current.over) == null ? void 0 : n.id), ee = zc({
    measure: y.dragOverlay.measure
  }), ae = (r = ee.nodeRef.current) != null ? r : S, me = j ? (a = ee.rect) != null ? a : V : null, Ie = !!(ee.nodeRef.current && ee.rect), dt = Lc(Ie ? null : V), Fe = di(ae ? Ze(ae) : null), we = jc(j ? B ?? S : null), Ve = Vc(we), Xe = Jc(h, {
    transform: {
      x: W.x - dt.x,
      y: W.y - dt.y,
      scaleX: 1,
    ...
    windowRect: Fe
  }), $t = A ? tn(A, W) : null, St = Fc(we), kt = la(St), Lt = la(St, [V]), Be = tn(Xe, kt), ft = me ? cc(me, Xe) : null, Ct = G && ft ? u({
    active: G,
    collisionRect: ft,
    droppableRects: O,
    droppableContainers: k,
    pointerCoordinates: $t
  }) : null, fn = Qa(Ct, "id"), [nt, Vn] = te(null), Er = Ie ? Xe : tn(Xe, Lt), Tr = sc(Er, (i = nt == null ? void 0 : nt.rect) != null ? i : null, V), Yn = je(
    (_e, Ae) => {
      let {
        sensor: Me,
        options: pt
      ...
      function Ot(We) {
        return async function() {
          ...
          X.current = null, vn(() => {
            _({
              type: We
            }), x(Nt.Uninitialized), Vn(null), Z(null), ue(null);
  ...
  }, [G, S, Ct, ft, N, ae, me, O, H, nt, we, Be]), Pc({
    ...q,
    delta: W,
    draggingRect: ft,
    pointerCoordinates: $t,
...
function au(e) {
  ...
  const i = fr(ou), {
    ...
    tabIndex: b = 0
  } = a ?? {}, w = (d == null ? void 0 : d.id) === t, _ = Te(w ? fi : ru), [D, E] = rr(), [I, x] = rr(), j = qc(c, t), T = Dn(n);
  Tt(
    () => (u.set(t, {
      id: t,
      key: i,
...
}, uu = [ce.Down, ce.Right, ce.Up, ce.Left], du = (e, { context: { active: t, droppableRects: n, droppableContainers: r, collisionRect: a } }) => {
  var i;
...
const pu = "_pop_1elvh_1", nn = {
  ...
  pop: pu
}, gi = ({ children: e, id: t, addClass: n, dragging: r, label: a, attribute: i, disabledDefaultAttributes: c, element: s, defaultStyle: d, __TYPE: f, ...l }) => {
  const u = s || "div", { listId: v, propValidate: h, validate: m, isDragging: b } = Te(vi), { attributes: w, listeners: _, setNodeRef: D, transform: E } = au({
    id: t,
    disabled: m,
    data: {
      label: a
...
const _p = ({ ...e }) => /* @__PURE__ */ p("span", { id: "hc_extension_svg_filters", ...e, children: /* @__PURE__ */ p("svg", { xmlns: "http://www.w3.org/2000/svg", version: "1.1", height: "0", children: /* @__PURE__ */ $("defs", { children: [
...
const bu = ({ children: e, addClass: t, ...n }) => /* @__PURE__ */ p("ol", { ...t && { className: `${t}` }, ...n, children: Ge(e, ["ListItem"]) });
bu.propTypes = {
  children: o.oneOfType([o.arrayOf(o.element), o.element]),
  addClass: o.string
};
const yu = ({ children: e, addClass: t, ...n }) => /* @__PURE__ */ p("ul", { ...t && { className: `${t}` }, ...n, children: Ge(e, ["ListItem"]) });
yu.propTypes = {
  children: o.oneOfType([o.arrayOf(o.element), o.element]),
  addClass: o.string
};
...
const hr = ut(), _u = Object.freeze({
  ESC: 27
}), Ci = ({ children: e, isOpen: t, onClose: n, finalFocusRef: r }) => {
  const a = J(), i = (f) => {
    const l = document.querySelector("#root");
    l.inert = f;
  }, c = (f) => {
    (f.keyCode || f.which) === _u.ESC && d();
  }, s = (f, l) => {
...
const xu = (e) => {
  ...
  previous: "anterior",
  next: "siguiente"
}), Eu = (e, t, n) => e === "page" ? `${n ? "" : "Ir a la "}página ${t}` : `Ir a la ${Ou[e]} página`, $i = ({
  renderItem: e,
  getItemAriaLabel: t,
  addClass: n,
  defaultStyle: r,
...
const Su = Object.freeze({
  ...
  LEFT: 37,
  RIGHT: 39
}), Cu = (e, t, n) => e === "section" ? `${n ? "" : "Ir a la "}sección ${t}` : `Ir a la ${Su[e]} sección`, Li = ({
  renderItem: e,
  showPrevButton: t,
  showNextButton: n,
  icons: r,
...
}, ha = typeof window < "u" && window.document && window.document.createElement ? zt.useLayoutEffect : zt.useEffect, Ue = "top", st = "bottom", lt = "right", He = "left", br = "auto", Bn = [Ue, st, lt, He], on = "start", Mn = "end", Bu = "clippingParents", Wi = "viewport", _n = "popper", qu = "reference", ga = /* @__PURE__ */ Bn.reduce(function(e, t) {
...
function od(e) {
  ...
  if (!(!i || !c)) {
    var u = rd(a.padding, n), v = Eo(i), h = d === "y" ? Ue : He, m = d === "y" ? st : lt, b = n.rects.reference[l] + n.rects.reference[d] - c[d] - n.rects.popper[l], w = c[d] - n.rects.reference[d], _ = qn(i), D = _ ? d === "y" ? _.clientHeight || 0 : _.clientWidth || 0 : 0, E = b / 2 - w / 2, I = u[h], x = D - v[l] - u[m], j = D / 2 - v[l] / 2 + E, T = Cn(I, j, x), N = d;
...
function ba(e) {
  ...
  if (f) {
    var j = qn(n), T = "clientHeight", N = "clientWidth";
    if (j === tt(n) && (j = Mt(n), mt(j).position !== "static" && s === "absolute" && (T = "scrollHeight", N = "scrollWidth")), j = j, a === Ue || (a === He || a === lt) && i === Mn) {
      I = st;
...
function _a(e, t, n) {
  return t === Wi ? so(hd(e, n)) : Ht(t) ? md(t, n) : so(gd(Mt(e)));
}
function bd(e) {
...
function yd(e, t, n, r) {
  var a = t === "clippingParents" ? bd(e) : [].concat(t), i = [].concat(a, [n]), c = i[0], s = i.reduce(function(d, f) {
    var l = _a(e, f, r);
...
function $n(e, t) {
  t === void 0 && (t = {});
  var n = t, r = n.placement, a = r === void 0 ? e.placement : r, i = n.strategy, c = i === void 0 ? e.strategy : i, s = n.boundary, d = s === void 0 ? Bu : s, f = n.rootBoundary, l = f === void 0 ? Wi : f, u = n.elementContext, v = u === void 0 ? _n : u, h = n.altBoundary, m = h === void 0 ? !1 : h, b = n.padding, w = b === void 0 ? 0 : b, _ = Xi(typeof w != "number" ? w : Ki(w, Bn)), D = v === _n ? qu : _n, E = e.rects.popper, I = e.elements[m ? D : v], x = yd(Ht(I) ? I : I.contextElement || Mt(e.elements.popper), d, l, c), j = sn(e.elements.reference), T = Ji({
    reference: j,
    element: E,
    strategy: "absolute",
    placement: a
  }), N = so(Object.assign({}, E, T)), W = v === _n ? N : j, H = {
...
function xd(e) {
  ...
  if (!t.modifiersData[r]._skip) {
    for (var a = n.mainAxis, i = a === void 0 ? !0 : a, c = n.altAxis, s = c === void 0 ? !0 : c, d = n.fallbackPlacements, f = n.padding, l = n.boundary, u = n.rootBoundary, v = n.altBoundary, h = n.flipVariations, m = h === void 0 ? !0 : h, b = n.allowedAutoPlacements, w = t.options.placement, _ = ht(w), D = _ === w, E = d || (D || !m ? [Jn(w)] : wd(w)), I = [w].concat(E).reduce(function(C, R) {
      return C.concat(ht(R) === br ? _d(t, {
        placement: R,
        boundary: l,
        rootBoundary: u,
        padding: f,
      ...
      var F = I[H], z = ht(F), G = ln(F) === on, X = [Ue, st].indexOf(z) >= 0, oe = X ? "width" : "height", Z = $n(t, {
        placement: F,
        boundary: l,
        rootBoundary: u,
        altBoundary: v,
...
function Id(e) {
  var t = e.state, n = e.options, r = e.name, a = n.mainAxis, i = a === void 0 ? !0 : a, c = n.altAxis, s = c === void 0 ? !1 : c, d = n.boundary, f = n.rootBoundary, l = n.altBoundary, u = n.padding, v = n.tether, h = v === void 0 ? !0 : v, m = n.tetherOffset, b = m === void 0 ? 0 : m, w = $n(t, {
    ...
    padding: u,
    altBoundary: l
  }), _ = ht(t.placement), D = ln(t.placement), E = !D, I = To(_), x = Nd(I), j = t.modifiersData.popperOffsets, T = t.rects.reference, N = t.rects.popper, W = typeof b == "function" ? b(Object.assign({}, t.rects, {
    placement: t.placement
  })) : b, H = typeof W == "number" ? {
    mainAxis: W,
    altAxis: W
  ...
  if (j) {
    if (i) {
      var G, X = I === "y" ? Ue : He, oe = I === "y" ? st : lt, Z = I === "y" ? "height" : "width", K = j[I], ue = K + w[X], ie = K - w[oe], P = h ? -N[Z] / 2 : 0, k = D === on ? T[Z] : N[Z], y = D === on ? -N[Z] : -T[Z], O = t.elements.arrow, C = h && O ? Eo(O) : {
        width: 0,
        height: 0
      }, R = t.modifiersData["arrow#persistent"] ? t.modifiersData["arrow#persistent"].padding : Zi(), S = R[X], A = R[oe], q = Cn(0, T[Z], C[Z]), U = E ? T[Z] / 2 - P - q - S - H.mainAxis : k - q - S - H.mainAxis, V = E ? -T[Z] / 2 + P + q + A + H.mainAxis : y + q + A + H.mainAxis, de = t.elements.arrow && qn(t.elements.arrow), L = de ? I === "y" ? de.clientTop || 0 : de.clientLeft || 0 : 0, B = (G = F == null ? void 0 : F[I]) != null ? G : 0, ee = K + U - B - L, ae = K + V - B, me = Cn(h ? sr(ue, ee) : ue, K, h ? Ut(ie, ae) : ie);
      j[I] = me, z[I] = me - K;
    }
    if (s) {
      var Ie, dt = I === "x" ? Ue : He, Fe = I === "x" ? st : lt, we = j[x], Ve = x === "y" ? "height" : "width", Xe = we + w[dt], $t = we - w[Fe], St = [Ue, He].indexOf(_) !== -1, kt = (Ie = F == null ? void 0 : F[x]) != null ? Ie : 0, Lt = St ? Xe : we - T[Ve] - N[Ve] - kt + H.altAxis, Be = St ? we + T[Ve] + N[Ve] - kt - H.altAxis : $t, ft = h && St ? nd(Lt, we, Be) : Cn(h ? Lt : Xe, we, h ? Be : $t);
      j[x] = ft, z[x] = ft - we;
    }
    t.modifiersData[r] = z;
  }
...
function Ld(e, t, n) {
  ...
  Po(i)) && (s = $d(t)), Je(t) ? (d = sn(t, !0), d.x += t.clientLeft, d.y += t.clientTop) : i && (d.x = Co(i))), {
    ...
    var l = {
      ...
      setOptions: function(_) {
        ...
        if (l.orderedModifiers = E.filter(function(F) {
          ...
          var I = Yd([].concat(E, l.options.modifiers), function(F) {
            var z = F.name;
            return z;
          });
          if (Vd(I), ht(l.options.placement) === br) {
      ...
      forceUpdate: function() {
        if (!v) {
          ...
          l.rects = {
            reference: Ld(D, qn(E), l.options.strategy === "fixed"),
            popper: Eo(E)
...
const zr = {
  ...
  const [l, u] = te(!1), v = J(null), h = J(null), m = t || At(), b = (x) => u(!1), w = (x) => {
    ...
    (x.keyCode | x.which) === tf.ESC && l && u(!l);
...
const Wr = {
  ...
  const [d, f] = te(!1), l = J(null), u = J(null), v = J(), h = t || At(), m = (T) => {
    ...
    (T.keyCode | T.which) === nf.ESC && d && f(!d);
...
const rf = () => {
...
}, of = "_active_i7dnv_90", af = "_iconPulse_i7dnv_1", be = {
  ...
  }), [E, I] = te(!1), [x, j] = te(100), T = J(null), N = J(null), W = J(null), H = J(null), F = J(null), z = J(null), G = J(null), X = J(null), [oe, Z] = te(!1), [K, ue] = Ya(), ie = (B) => {
...
const lf = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  ...
  clsx: Ca,
  default: Ca
}, Symbol.toStringTag, { value: "Module" })), cf = /* @__PURE__ */ Es(lf);
var Oe = {}, wt = {};
...
Oe.addClassName = ps;
Oe.addEvent = _f;
Oe.addUserSelectStyles = Nf;
Oe.createCSSTransform = Cf;
Oe.createSVGTransform = Pf;
Oe.getTouch = Rf;
Oe.getTouchIdentifier = Df;
Oe.getTranslation = Do;
Oe.innerHeight = Ef;
Oe.innerWidth = Tf;
Oe.matchesSelector = fs;
Oe.matchesSelectorAndParentsTo = yf;
Oe.offsetXYFromParent = Sf;
Oe.outerHeight = xf;
Oe.outerWidth = Of;
Oe.removeClassName = vs;
Oe.removeEvent = wf;
Oe.removeUserSelectStyles = If;
var et = wt, Pa = bf(Gt);
function cs(e) {
...
wr.default = void 0;
var Hr = Yf(Le), Ke = Io(o), Vf = Io(ka), $e = Oe, Rt = xt, Gr = wt, wn = Io(xr);
function Io(e) {
...
(function(e) {
  ...
  var n = m(Le), r = v(o), a = v(ka), i = v(cf), c = Oe, s = xt, d = wt, f = v(wr), l = v(xr), u = ["axis", "bounds", "children", "defaultPosition", "defaultClassName", "defaultClassNameDragging", "defaultClassNameDragged", "position", "positionOffset", "scale"];
  function v(y) {
...
var gs = as, ms = gs.default, ep = gs.DraggableCore;
sf.exports = ms;
kn.default = ms;
kn.DraggableCore = ep;
const tp = (e, t, n) => {
  ...
  const [i, c] = te("00:00"), [s, d] = te(!1), [f, l] = te(!1), [u, v] = te(!1), { video1: h, video2: m } = tp("body", r, a), [b, w] = te({
    state: !1,
    icon: Zr,
    label: "Reproducir video"
  }), [_, D] = te({
  ...
  return /* @__PURE__ */ p(kn, { nodeRef: F, handle: "strong", position: E, onDrag: H, children: /* @__PURE__ */ $(
    "div",
    {
      ref: F,
...
const Xr = {
  ...
  ESC: 27,
  TAB: 9
}), hp = 'a[href], area[href], input:not([disabled]), select:not([disabled]), textarea:not([disabled]), button:not([disabled]), iframe, object, embed [tabindex="0"], [contenteditable], audio:not([tabindex="-1"])', _s = ({
  id: e,
  children: t,
  addClass: n,
  hasArrow: r,
  ...
  const w = (E) => {
    const I = v.current.querySelectorAll(hp), x = u.current, j = I[0], T = I[I.length - 1];
