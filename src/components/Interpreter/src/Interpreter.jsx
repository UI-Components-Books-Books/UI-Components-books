...
export const Interpreter = ({ width, addClass, image, pathVideo, pathname }) => {
  ...
  const refVideo1 = createRef();
  const refVideo2 = createRef();
  ...
  return (
    <Draggable handle="strong" position={deltaPosition} onDrag={handleDrag}>
      <div
        className={`${css['menu-float']} ${
          (showVideo1 || showVideo2) && css['menu-float-active']
        } ${css['menu-float-box']} ${css['box']} ${css['no-cursor']}`}>
        <Row>
          <div
            className={`${css['c-vid-container']} ${addClass}`}
            ...
            <div className={`${css['c-vid']} ${addClass}`} style={{ maxWidth: `${width}px` }}>
              {showVideo1 && (
                <video
                  ...
                  className={`${css['no-captions']}`}></video>
              )}
              {showVideo2 && (
                <video
                  src={video2}
          ...
          <div className={css['menu-float-dropdown']}>
            {((!showVideo1 && !showVideo2) ||
              ...
              <button
                ...
                {showVideo1 || showVideo2 ? <SvgRepeat /> : <SvgMoreVert />}
