    ...
    <Col xs='11'>
      <Row display='flex' justify-content='center' align-items='center'>
        ...
        <Col xs='11' mm='10' md='9' lg='5' hd='4'>
          ...
          <p className='u-my-4'>
            Dicta asperiores rerum velit! Dolores maxime est adipisci eum esse
            quas in cumque, commodi debitis amet magni, earum quod rem
            dignissimos quis? Ipsam similique excepturi cupiditate quidem saepe
            aliquam quam. Dolor illum cupiditate expedita! Aspernatur distinctio
            at fugiat recusandae placeat alias sunt culpa optio nemo autem quasi
            ex repellendus qui eius quaerat minima, animi quidem libero
            voluptatem magnam quos quibusdam. Laudantium doloremque sed
            voluptatum at. Numquam, ipsam ipsa perferendis odio hic nam laborum,
            quaerat similique pariatur doloribus nisi sequi eos reiciendis
            aliquid porro sapiente omnis reprehenderit maxime enim quo est.
          </p>
        </Col>
      </Row>
    </Col>
