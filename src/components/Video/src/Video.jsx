      ...
      <div className={`${css['c-vid__container']} ${addClass}`} ref={refCont}>
        <div className={css['c-vid__wrapper']}>
          ...
          <div className={css['c-vid__icon-container']}>
            ...
            <div ref={refPlayPulse} className={css['c-vid__icon']}>
              <Icon>
                <svg xmlns='http://www.w3.org/2000/svg' height='48' width='48' viewBox='0 0 48 48'>
                  {getstateVideoPlay.state ? (<path id='play' d='M16 37.85v-28l22 14Z' />) : (<path id='pause' d='M28.25 38V10H36v28ZM12 38V10h7.75v28Z' />)}
                </svg>
              </Icon>
            </div>
        ...
        <div className={css['c-vid__controls']}>
          ...
          >
            <Icon>
              <svg xmlns='http://www.w3.org/2000/svg' height='48' width='48' viewBox='0 0 48 48'>
                {getstateVideoPlay.state ? (<path id='pause' d='M28.25 38V10H36v28ZM12 38V10h7.75v28Z' />) : (<path id='play' d='M16 37.85v-28l22 14Z' />)}
              </svg>
            </Icon>
          </button>
            ...
            <Icon>
              <svg xmlns='http://www.w3.org/2000/svg' height='48' width='48' viewBox='0 0 48 48'>
                {getStateScreen.state
                  ? <path id='fullscreen_exit' d='M16.65 38v-6.65H10v-3h9.65V38Zm11.7 0v-9.65H38v3h-6.65V38ZM10 19.65v-3h6.65V10h3v9.65Zm18.35 0V10h3v6.65H38v3Z' />
                  : <path id='fullscreen' d='M10 38v-9.65h3V35h6.65v3Zm0-18.35V10h9.65v3H13v6.65ZM28.35 38v-3H35v-6.65h3V38ZM35 19.65V13h-6.65v-3H38v9.65Z' />}
              </svg>
            </Icon>
          </button>
        </div>
